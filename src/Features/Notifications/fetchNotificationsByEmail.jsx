...
export const fetchNotificationsByEmail = createAsyncThunk("notificationsByEmail/fetchNotificationsByEmail", async (email) => {
  const res = await axios.get(`http://localhost:5000/notifications?email=${email}`);

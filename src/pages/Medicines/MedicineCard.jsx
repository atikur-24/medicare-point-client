...
const MedicineCard = ({ medicine }) => {
    ...
    return (
      <div className="card card-compact group bg-white rounded-md hover:shadow-lg transition-shadow relative">
        <p className="bg-my-accent rounded-md py-1 px-2 text-xs font-medium text-white absolute top-4 left-4">-{discount}% OFF</p>
        ...
        <div className="card-body space-y-2 lg:space-y-3">
          ...
          <div className="space-y-3">
            ...
            <p className="inline-flex gap-1">
              ...
              <span className="font-semibold inline-flex items-center text-[16px] text-gray-5 line-through"><TbCurrencyTaka /> 170</span>
            </p>
          </div>

    ...
    <div>
      <div className="my-container flex flex-col-reverse md:flex-row justify-between gap-6 items-center ">
        <div className="w-full md:w-[70%] space-y-6">
          ...
          <p className="text-gray-5">We are try to provide our best services for every single customer. You will got 100% original medicine form medicare point. Our goal is to deliver safe and original products to customers.</p>
          <Link to="/medicines">
      ...
      <div className="my-container flex flex-col flex-col-reverse md:flex-row justify-between gap-6 items-center ">
        <div className="w-full md:w-[70%] space-y-6">
          ...
          <p className="text-gray-5">you can order medicine according to your needs by online. We will try to delivery it to you as soon as possible. We will deliver your product to you with utmost care.</p>
          <Link to="/about-us">
            <button type="button" className="my-btn mt-6">

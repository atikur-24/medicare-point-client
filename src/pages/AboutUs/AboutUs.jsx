      ...
      <div className=" my-container  relative ">
        <div className=" clear-left flex flex-col flex-col-reverse md:flex-row gap-6 mg:gap-0 justify-between ">
          <div className="w-full space-y-7">
            ...
            <h2 className="mg:text-3xl lg:text-5xl font-bold  ">With us, expect more than just a pharmacy.</h2>
            <p className=" md:w-10/12 text-gray-5">
              Erat litora dignissim consectetur sit mollis. Placerat gravida dolor integer mollis habitant felis consectetur lorem platea ac hendrerit. Vitae platea massa consectetuer tristique
              vivamus vulputate suspendisse blandit.
            </p>

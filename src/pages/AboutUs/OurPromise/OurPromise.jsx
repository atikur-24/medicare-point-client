      ...
      <div className="mt-10 flex flex-col md:flex-row justify-between">
        ...
        <div className="bg-my-primary w-full text-white rounded-b-lg md:rounded-r-lg md:rounded-bl-none p-8 space-y-10">
          <div className="flex gap-6 items-center">
            ...
            <div>
              <h4 className="text-lg font-semibold">Biggest variety</h4>
          ...
          <div className="flex gap-6 items-center">
            ...
            <div>
              <h4 className="text-lg font-semibold">Best Price</h4>
          ...
          <div className="flex gap-6 items-center">
            ...
            <div>
              <h4 className="text-lg font-semibold">Ease & Speed</h4>
          ...
          <div className="flex gap-6 items-center">
            ...
            <div>
              <h4 className="text-lg font-semibold">100% Protected</h4>

...
const LabDetails = ({ open, toggleOpen }) => {
  return (
    <div className={`${open ? "hidden" : "block"} z-10 fixed  bg-[#F2FBFF] border-[3px] border-solid border-[#FCB716] rounded-l-lg max-h-[500px]  md:w-96 w-full overflow-auto right-0 bottom-0  `}>

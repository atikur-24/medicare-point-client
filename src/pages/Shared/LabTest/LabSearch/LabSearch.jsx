  ...
  return (
    <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center md:gap-10 ">
      <div className="md:w-[40%]">
        <form className="flex items-center  ">
          <input
            ...
            className="input-accent  h-16 w-full   rounded-l-lg   border px-6 focus:input-bordered"
            type="search"
            placeholder="Search Test and Packages"
          />
          <button
            type="button"
            className=" flex h-16 items-center justify-center rounded-r-lg bg-my-primary px-4  "
          >
      ...
      <div className="md:w-[50%] lg:w-[40%] ">
        <div className=" flex rounded-lg border border-gray-3  bg-white px-4 py-2 md:items-center  ">
          <p className="flex w-80 items-center justify-center rounded bg-my-primary py-4  font-nunito text-sm font-bold uppercase text-white lg:text-base">
            Our Services Area
          </p>
          ...
          <Marquee
            className="font-medium capitalize text-title-color"
            pauseOnClick
            speed={30}
          >
            Badda,Demra,Dhanmondi,Gulshan,Mirpur,Savar,Uttara,Mohammadpur,shyamoli
            ,kallyanpur,
          </Marquee>
        </div>
      </div>

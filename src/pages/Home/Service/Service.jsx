  ...
  return (
    <div className="my-container">
      ...
      <div className="my-container grid gap-10 lg:gap-0 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 bg-[#e9f6f9] rounded-lg">
        ...
        <div className="flex flex-col justify-center items-center">
          <img className="w-28 hover:scale-110 transition-all duration-150" src={clockImg} alt="" />
          <h3 className="text-2xl font-semibold mt-2">45min</h3>
          <p className="text-lg font-semibold txt-gray-5">Avg. Delivery Time</p>
        </div>

        <div className="flex flex-col justify-center items-center">
          <img className="w-28 hover:scale-110 transition-all duration-150" src={medicineImg} alt="" />
          <h3 className="text-2xl font-semibold mt-2">
        ...
        <div className="flex flex-col justify-center items-center">
          <img className="w-28 hover:scale-110 transition-all duration-150" src={deliveryImg} alt="" />
          <h3 className="text-2xl font-semibold mt-2">

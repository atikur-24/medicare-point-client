  ...
  return (
    <div className="my-container">
      ...
      <div className="my-container grid gap-10 lg:gap-0 grid-cols-1 md:grid-cols-2 text-title-color lg:grid-cols-4 bg-card rounded-lg border border-gray-3">
        <div className="relative flex flex-col justify-center items-center p-10 shadow-lg m-4 group">
          ...
          <p className="text-lg font-semibold text-my-accent">Registered Users</p>
        </div>
        ...
        <div className="relative flex flex-col justify-center items-center p-10 shadow-lg m-4 group">
          ...
          <p className="text-lg font-semibold text-my-accent">Avg. Delivery Time</p>
        </div>
        ...
        <div className="relative flex flex-col justify-center items-center p-10 shadow-lg m-4 group">
          ...
          <p className="text-lg font-semibold text-my-accent">Enlisted Items</p>
        </div>
        ...
        <div className="relative flex flex-col justify-center items-center p-10 shadow-lg m-4 group">
          ...
          <p className="text-lg font-semibold text-my-accent">Orders Delivered</p>
        </div>
      </div>
    </div>
  );

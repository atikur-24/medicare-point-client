...
const Service = () => {
  return (
    <div className="my-container">
      ...
      <div data-testid="cards-container" className="my-container !py-8 md:py-auto grid grid-cols-1 md:grid-cols-2 text-title-color lg:grid-cols-4">
      ...
      <div className="my-container !py-8 md:py-auto grid grid-cols-1 md:grid-cols-2 text-title-color xl:grid-cols-4">

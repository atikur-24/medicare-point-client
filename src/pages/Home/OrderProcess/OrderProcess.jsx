  ...
  return (
    <div className="my-container">
      ...
      <div data-testid="orderProcess-container" className="grid grid-cols-1 md:grid-cols-2 md:mt-4 xl:grid-cols-5 gap-6">
        <div className="orderProcess-card card card-compact bg-base-100 border border-gray-3 rounded-md">
          <figure>
            <img className="w-20 md:w-[70px] mx-auto hover:scale-110 transition-all duration-100 cursor-pointer pt-3 lg:pt-5" src={image1} alt="Shoes" />
          </figure>
        ...
        <div className="orderProcess-card card card-compact bg-base-100 border border-gray-3 rounded-md">
          <figure>
            <img className="w-20 md:w-[70px] mx-auto hover:scale-110 transition-all duration-100 cursor-pointer pt-3 lg:pt-5" src={image2} alt="Shoes" />
          </figure>
          <div className="card-body mt-2 md:mt-4 lg:mt-8">
        ...
        <div className="orderProcess-card card card-compact bg-base-100 border border-gray-3 rounded-md">
          <figure>
            <img className="w-20 md:w-[70px] mx-auto hover:scale-110 transition-all duration-100 cursor-pointer pt-3 lg:pt-5" src={image3} alt="Shoes" />
          </figure>
          <div className="card-body mt-2 md:mt-4 lg:mt-8">
        ...
        <div className="orderProcess-card card card-compact bg-base-100 border border-gray-3 rounded-md">
          <figure>
            <img className="w-20 md:w-[70px] mx-auto hover:scale-110 transition-all duration-100 cursor-pointer pt-3 lg:pt-5" src={image4} alt="Shoes" />
          </figure>
          <div className="card-body mt-2 md:mt-4 lg:mt-8">
        ...
        <div className="orderProcess-card card card-compact bg-base-100 border border-gray-3 rounded-md">
          <figure>
            <img className="w-20 md:w-[70px] mx-auto hover:scale-110 transition-all duration-100 cursor-pointer pt-3 lg:pt-5" src={image5} alt="Shoes" />
          </figure>
          <div className="card-body mt-2 md:mt-4 lg:mt-8">

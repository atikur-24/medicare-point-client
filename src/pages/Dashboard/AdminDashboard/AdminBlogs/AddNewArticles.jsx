      ...
      <div className="grid grid-cols-1">
        <div>
          <img
            ...
            src="https://st2.depositphotos.com/1561359/6865/v/450/depositphotos_68650923-stock-illustration-doctor-writing-healthy-tips-words.jpg"
            alt=""
          />
        </div>
        <div className="bg-gray-3 p-2">
          <h1 className="py-2 text-2xl font-bold">Add A New Articles</h1>

    ...
    <div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mx-2 mt-1">
        <div className="rounded-md shadow-md bg-card py-3 flex items-center justify-center gap-5">
          ...
          <div>
            <h4 className="text-2xl">
              <CountUp enableScrollSpy end={125} duration={3} /> Users
            </h4>
        ...
        <div className="rounded-md shadow-md bg-card py-3 flex items-center justify-center gap-5">
          ...
          <div>
            <h4 className="text-2xl">
              <CountUp enableScrollSpy end={50} duration={3} /> Brands
            </h4>
            <p className="text-base">All collaborated Brands</p>
          </div>
        </div>
        <div className="rounded-md shadow-md bg-card py-3 flex items-center justify-center gap-5">
          <img className="w-28 py-4 object-cover" src={doctorImg} alt="pharmacyImg" />
          <div>
            <h4 className="text-2xl">
              <CountUp enableScrollSpy end={10} duration={3} /> Doctors
            </h4>
        ...
        <div className="rounded-md shadow-md bg-card py-3 flex items-center justify-center gap-5">
          ...
          <div>
            <h4 className="text-2xl">
              <CountUp enableScrollSpy end={546} duration={3} />+ Medicines
            </h4>
        ...
        <div className="rounded-md shadow-md bg-card py-3 flex items-center justify-center gap-5">
          ...
          <div>
            <h4 className="text-2xl">
              <CountUp enableScrollSpy end={100} duration={3} />+ Lab Tests
            </h4>
        ...
        <div className="rounded-md shadow-md bg-card py-3 flex items-center justify-center gap-5">
          ...
          <div>
            <h4 className="text-2xl">
              <CountUp enableScrollSpy end={15} duration={3} /> Pharmacists
            </h4>

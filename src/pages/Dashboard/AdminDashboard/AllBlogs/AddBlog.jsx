...
const AddBlog = () => {
  ...
  return (
    <div className="pb-8">
      <div className="box-shadow mx-auto max-w-5xl rounded-2xl bg-white p-6">
        <h3 className="my-5 text-center text-3xl font-semibold text-my-primary">
          Add New Blog
        </h3>
        ...
        <form onSubmit={handleBlog} className="add-blog-form space-y-3">
          <div>
            <h4>Blog Title</h4>
            <input
              className=" input input-bordered  outline-none  placeholder:text-gray-6 focus:!outline-none"
              required
              type="text"
              name="title"
              id=""
          ...
          <div>
            <h4>Blog Topic</h4>
            <input
              className="placeholder-gray-400 rounded-md border px-3 py-2"
              required
              type="text"
              name="topic"
              id=""
          ...
          <div className="mt-4 flex items-center gap-4">
            ...
            <input
              onClick={() => setBlogDetails("")}
              type="reset"
              value="Reset"
              className="!btn !btn-error !w-[64px]"
            />
          </div>
        </form>
      </div>

...
const ApplicationDetail = () => {
  ...
  return (
    <div className="px-20 py-8 ">
      <div className="flex flex-col gap-16 rounded-lg bg-white p-14 shadow-xl md:flex-row">
        <div className="  ">
          <img
        ...
        <div className="   border-l-4 border-my-primary pl-6 ">
          <h3 className="text-2xl font-semibold">
            Pharmacist Application Details
          </h3>
          <div className="mt-10 space-y-4">
            <p className="text-lg text-gray-5">
              <span className="font-bold text-gray-7">Pharmacy Name:</span>{" "}
              {pharmacyName}
            </p>
            <p className="text-lg text-gray-5 ">
              <span className="font-bold text-gray-7">Pharmacy Email:</span>{" "}
              {pharmacyEmailAddress}
            </p>
            <p className="text-lg text-gray-5">
            ...
            <p className="text-lg text-gray-5">
              ...
              <div className="pl-4">
                ...
                <p>
                  <span className=" font-semibold">Pharmacy Location:</span>{" "}
                  {pharmacyFullAddress}
                </p>
              </div>
            </p>
            ...
            <p className="text-lg text-gray-5">
              <span className="font-bold text-gray-7">Medicine Sold:</span>{" "}
              {medicinesSold}
            </p>
            <p className="text-lg text-gray-5">
              <span className="font-bold text-gray-7">
          ...
          <div className="mt-10 flex items-center justify-between">
            <div>
              {applicationType !== "Approved" ? (
                <button
                  onClick={() =>
                    ApprovePR(_id, email, "Approved", "Pharmacist", application)
                  }
                  type="button"
            ...
            {applicationType === "pending" ? (
              <button
                onClick={() => ApprovePR(_id, email, "deny", "user")}
                type="button"
                className="reset-btn"
              >
                Deny
